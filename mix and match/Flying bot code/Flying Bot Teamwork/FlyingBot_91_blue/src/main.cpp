...
void Spin_Robot()
{
    ...
    MotorLeft.setVelocity(100.0, percent);
    MotorRight.setVelocity(100.0, percent);
    MotorLeft.spinFor(reverse, 300.0, degrees, false);
    MotorRight.spinFor(forward, 300.0, degrees, true);
    MotorRight.setStopping(coast);
    MotorLeft.setStopping(coast);
    MotorLeft.stop();
    MotorRight.stop();
...
void Ajpin()
{
    ...
    MotorLeft.spinFor(forward, 186.5, degrees, false);
    MotorRight.spinFor(forward, 186.5, degrees, true);
    // MotorLeft.setStopping(hold);
    // MotorRight.setStopping(hold);
    // MotorLeft.stop();
    // MotorRight.stop();
...
void flip()
{
    ...
    while (MotorPin.velocity(vex::velocityUnits::pct) > fabs(5) || MotorPin.position(degrees) < 780)
    {
        continue;
    }
    MotorPin.stop(coast);
