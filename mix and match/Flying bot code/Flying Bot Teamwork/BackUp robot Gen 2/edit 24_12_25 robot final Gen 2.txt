...
bool front_back, pin, phase, beamOn, isBusy, blink, boot, autobeam, stop, stand_off_up, start_stand_off_up, autoBeamY, stakeONGo, MakeY;
...
void ControllerDChanged()
{
  if (Controller.AxisD.position() >= 90.0)
  {
    ...
    guide.retract(cylinder2);
    // wait(300, msec);
    // MotorPin.spinFor(forward, 70.0, degrees, false);
    // MotorPin.setVelocity(100, percent);
    // stakeONGo = true;
  }
  else if (Controller.AxisD.position() <= -90.0)
